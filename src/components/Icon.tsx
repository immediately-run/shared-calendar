// Lucide-style inline icons (16–24px, currentColor). One component, keyed by name,
// so the app needs no icon font and no emoji.
type IconName =
  | 'plus' | 'left' | 'right' | 'close' | 'paperclip' | 'image' | 'file' | 'link'
  | 'trash' | 'edit' | 'users' | 'lock' | 'calendar' | 'download' | 'external' | 'repeat' | 'check' | 'menu';
